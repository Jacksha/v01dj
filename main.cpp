...
{
	CreateWindow("Button", "one", WS_CHILD | WS_VISIBLE, 85, 70, 120, 40, hw, (HMENU)id_button1, 0, 0);
	CreateWindow("Button", "two", WS_CHILD | WS_VISIBLE, 85, 130, 120, 40, hw, (HMENU)id_button2, 0, 0);
}
